package br.com.fiap.postech.pontoeletronico.pontoeletronico.security
...
class JwtUtil {
    ...
    fun generateToken(matricula: String): String {
        return Jwts.builder()
    ...
    private fun getClaims(token: String): Claims {
        try {
            ...
            throw AutenticacaoException("Token Inválido")
        }
    }
}